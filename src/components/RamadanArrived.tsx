  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-4 mb-6">
        ...
        <motion.div variants={scaleIn}>
          <Moon className="w-16 h-16 text-teal-600 fill-teal-600" />
        </motion.div>
        <motion.div variants={scaleIn}>
          <Star className="w-12 h-12 text-yellow-400 fill-yellow-400 animate-pulse" />
        </motion.div>
      ...
      {/* Main message */}
      <motion.h2
        className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-teal-600 via-green-600 to-teal-600 bg-clip-text text-transparent mb-4"
        variants={fadeIn}
      >
        Ramadan Mubarak! 🌙
      </motion.h2>
      ...
      <motion.div
        className="bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-700 dark:via-slate-600 dark:to-slate-700 rounded-xl p-6 max-w-2xl mx-auto"
        variants={fadeIn}
      >
